...
# use a prompt template to get answers from Llama 3
...
def main():
    ...
    parser.add_argument('-q', '--question', type = str, default = 'What are classic monopoly rules?', help = 'Enter a question')
