...
def get_vector_db(load_saved = False):
    ...
    if load_saved:
        # use an English language embedding model to create embeddings in 384 dimensions
        db = FAISS.load_local("db_name", get_embedding(model_name = "sentence-transformers/all-MiniLM-l6-v2")) 
